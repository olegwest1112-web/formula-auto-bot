...
const text = '🏁 FORMULA · ТЕСТОВИЙ КАТАЛОГ\n\n4 автомобілі з фото, цінами та характеристиками. Пошук, фільтри та обране.\n\nЩоб відкрити Mini App: перейдіть до бота, натисніть «Почати», потім кнопку «Каталог авто» біля поля повідомлення.\n\nЦе демонстрація. Тестові заявки не надсилаються менеджерам салону.';
